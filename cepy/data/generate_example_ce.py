...
sys.path.insert(1, 'G:/My Drive/Pythonfiles/cepy')
import cepy as ce
import gzip
import numpy as np
parms = {'dimensions': 30, 'walk_length': 20, 'num_walks': 2, 'workers': 6,
...
ce_subject1.save_model('ce_subject1_v3.pkl')
# jsonStr = json.dumps(ce_subject1.__dict__)
#
# path = 'sc_subject1_matrix.json.gz'
